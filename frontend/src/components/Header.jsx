    ...
    <>
      <header className='header flex justify-between items-center py-5 px-15 bg-gray-700'>
        ...
        <div className='flex gap-5 items-center'>
          {isLoggedIn ? (<>
            <Button color='bg-green-500' text='Dashboard' url='/dashboard'/>
            <button onClick={handleLogout} className='bg-red-500 rounded py-2 px-5 font-semibold cursor-pointer active:scale-90'>Logout</button>
            </>) : (<>
